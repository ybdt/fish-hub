...
def usage():
    ...
    parser.add_argument("-f", "--file", help="使用zoomeye-python生成的JSON文件", required=True);
    parser.add_argument("-c", "--count", type=int, help="指定JSON文件中设备的个数，用于传递给提取器函数", required=True);
